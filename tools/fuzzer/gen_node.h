...
using GenNodeOrRand = std::variant<std::shared_ptr<GenNode>, rand_t>;
...
class GenNode {
 public:
  ...
  // value generated by an RNG.
  const std::vector<GenNodeOrRand>& children() const { return children_; }
 ...
 private:
  ...
  bool valid_ = false;
  std::vector<GenNodeOrRand> children_;
};
...
class GenTreeVisitor {
 public:
  ...
  virtual void visit_random_value(rand_t) {}
};
